...
class __TwigTemplate_896b33c6f6e7c43fbbb268f1f2b6d649 extends Template
{
    private $source;
    private $macros = [];
...
(isset($context["attribute"]) || array_key_exists("attribute", $context) ? $context["attribute"] : (function () { throw new RuntimeError('Variable "attribute" does not exist.', 422, $this->source); })()), "type", [], "any", false, false, false, 422) == "string")) {
                    ...
                    echo "                                        </td>
                                        <td>";
                    // line 431
                    echo $this->extensions['Symfony\Bundle\WebProfilerBundle\Twig\WebProfilerExtension']->dumpData($this->env, twig_get_attribute($this->env, $this->source, $context["decision"], "seek", [0 => "object"], "method", false, false, false, 431));
                    echo "</td>
                                    </tr>
...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", "@Security/Collector/security.html.twig", "C:\\wamp\\www\\Projet coaching\\v1.0_coaching_symfony\\vendor\\symfony\\security-bundle\\Resources\\views\\Collector\\security.html.twig");
    }
}
