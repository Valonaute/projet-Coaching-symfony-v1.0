...
class __TwigTemplate_07cc8ffb28f9d529eeeebb53baaf1893 extends Template
{
    private $source;
    private $macros = [];
...
{% block title %}Création produit {% endblock %}

{% block content %}
    {{ form(form)}}
{% endblock %}", "product/create.html.twig", "C:\\wamp\\www\\symfony\\v1.0_coaching_symfony\\templates\\product\\create.html.twig");
    }
}
