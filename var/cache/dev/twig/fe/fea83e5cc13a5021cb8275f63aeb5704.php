...
<div class=\"container\">
    <form method=\"post\" class=\"form col-4 mx-auto\">
        ...
        {% if app.user %}
            <div class=\"mb-3\">
                Vous êtes connecté avec le mail : {{ app.user.userIdentifier }}, <a href=\"{{ path('app_logout') }}\">Déconnexion</a>
            </div>
        {% endif %}
...
{% endblock %}
", "security/login.html.twig", "C:\\wamp\\www\\symfony\\v1.0_coaching_symfony\\templates\\security\\login.html.twig");
    }
}
