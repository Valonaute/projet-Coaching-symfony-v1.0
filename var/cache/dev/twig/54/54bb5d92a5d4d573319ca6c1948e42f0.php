...
<table class=\"table\">
    ...
    ";
        ...
        <td>
            <a href=\"";
            // line 22
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("update_category", ["id" => twig_get_attribute($this->env, $this->source, $context["category"], "id", [], "any", false, false, false, 22)]), "html", null, true);
            echo "\" class=\"btn btn-primary m-2\">modifier</a>
            <a href=\"";
            // line 23
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("delete_category", ["id" => twig_get_attribute($this->env, $this->source, $context["category"], "id", [], "any", false, false, false, 23)]), "html", null, true);
...
";
    ...
    {
        return array (  121 => 31,  115 => 27,  105 => 23,  101 => 22,  96 => 20,  92 => 19,  88 => 18,  85 => 17,  81 => 16,  68 => 5,  58 => 4,  35 => 1,);
    }
...
{% endblock %}
", "category/show.html.twig", "C:\\wamp\\www\\symfony\\v1.0_coaching_symfony\\templates\\category\\show.html.twig");
    }
}
